...
public class FDCalculator {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		driver.findElement(By.cssSelector("#wzrk-cancel")).click(); // cancel alert box
		...
		for (int i = 1; i <= rows; i++) {
			// 1) read data from excel and call methods from ExcelUtils file
			...
			if (Double.parseDouble(expMvalue) == Double.parseDouble(actMvalue)) {
